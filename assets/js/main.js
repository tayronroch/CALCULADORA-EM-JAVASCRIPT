// EXPLICAÇÃO AO FINAL DA AULA 78 UDEMY POR VOLTA DOS 22M
function Calculadora() {  // 1 criar a função fabrica
  this.display = document.querySelector('.display');

  this.inicia = () => { // 4 - gerenciador de eventos capturaCliques e capturaEnter.
    this.capturaCliques();
    this.capturaEnter();
  };
